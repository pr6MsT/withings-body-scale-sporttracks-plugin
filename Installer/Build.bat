...
SET PLUGIN_FOLDER=WithingsBodyScale
...
SET INSTALL_PACKAGE_NAME=withingsbodyscale-v3.0.NNNN.st3plugin
...
COPY ..\bin\x86\release\WithingsBodyScale.dll %PLUGIN_FOLDER%
